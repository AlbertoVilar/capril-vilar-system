...
INSERT INTO goat_farms (name, owner_id, address_id, tod) VALUES ('Capril Vilar', 1, 1, '16432');
...
--  AVÓS MATERNOS
INSERT INTO goats (registration_number, name, gender, breed, goat_color, status, category, birth_date, father_id, mother_id, active, goat_farm_id) VALUES ('1650113018', 'JOSA CAPRIMEL', 'Macho', 'Alpina', 'Indefinida', 'ATIVO', 'Reprodutor', '2013-01-01', '1403110395', '1650112018', true, 1);
INSERT INTO goats (registration_number, name, gender, breed, goat_color, status, category, birth_date, father_id, mother_id, active, goat_farm_id) VALUES ('2114513061', 'PANTALONA DO CRS', 'Fêmea', 'Alpina', 'Indefinida', 'ATIVO', 'Matriz', '2013-01-01', '2104406006', '2114510040', true, 1);

--  PAIS
INSERT INTO goats (registration_number, name, gender, breed, goat_color, status, category, birth_date, father_id, mother_id, active, goat_farm_id) VALUES ('1635717065', 'C.V.C SIGNOS PETROLEO', 'Macho', 'Alpina', 'Indefinida', 'ATIVO', 'Reprodutor', '2017-01-01', '1422915618', '1422913470', true, 1);
INSERT INTO goats (registration_number, name, gender, breed, goat_color, status, category, birth_date, father_id, mother_id, active, goat_farm_id) VALUES ('2114517012', 'NAIDE DO CRS', 'Fêmea', 'Alpina', 'Indefinida', 'ATIVO', 'Matriz', '2017-01-01', '1650113018', '2114513061', true, 1);
